...
> Choose from [[Strategy 1 - Gumroad Digital Products|Playbooks]] in the Strategies folder. Check the ones you're running.

| Strategy | Status | Capital Deployed | Revenue (Cumulative) | Health |
|---|---|---|---|---|
| | | | | |

> Add rows as you activate strategies. You choose which playbooks to pursue.
...
| Pool | Amount | Status |
|---|---|---|
| Trading capital | $50 | Not deployed |
| API credits (Claude/other) | $10 | Not deployed |
| Optional (Chrome Dev, domains, etc.) | $5 | Not deployed |
| Reserve | $35 | Held |
| **Total** | **$100** | |
...
> All accounts are yours. You supply your own API keys for n8n workflows.

| Account | Status | Notes |
|---|---|---|
| Kalshi | Not created | Fund with trading capital |
...
> Store your actual keys securely (1Password, etc.) — just track status here.

| Service | Credential Type | Status | Notes |
|---|---|---|---|
| Claude/Anthropic | API key | Not created | For AI tasks in your n8n workflows |
| Kalshi | API key + secret | Not created | For trading bot |
| Polymarket | Wallet + API | Not created | For arb scanner |
...
| Your Vercel (if needed) | You | $0 (free tier) | For your SaaS if you build one |
